...
const getServicesForAdmin = async (req, res) => {
    try {
        ...
        const totalServices = await EmergencyService.countDocuments(searchQuery);


        let services = await EmergencyService.find(searchQuery)
...
const updateService = asyncHandler(async (req, res) => {
    try {
        ...
        const existingService = role === "admin" ? await EmergencyService.findById(shopServiceId) : await EmergencyService.findOne({ _id: shopServiceId, createdBy: id })
